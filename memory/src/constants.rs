...
pub const ROM_BANK_SIZE: usize = ROM_BANK_END - ROM_BANK_START;
...
pub const EXTERNAL_RAM_SIZE: usize = EXTERNAL_RAM_END - EXTERNAL_RAM_START;

pub const RAM0_START: usize = 0xC000;
pub const RAM0_END: usize = 0xCFFF;
pub const RAM0_SIZE: usize = RAM0_END - RAM0_START;

pub const RAM_BANK_START: usize = 0xD000;
pub const RAM_BANK_END: usize = 0xDFFF;
pub const RAM_BANK_SIZE: usize = RAM_BANK_END - RAM_BANK_START;
