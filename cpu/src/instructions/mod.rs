...
fn get_cb_instruction(opcode: u8) -> Option<Instruction> {
    Some(match opcode {
        ...
        0x08 => bitwise::rotate_right_b_extended,       // RRC B
        0x09 => bitwise::rotate_right_c_extended,       // RRC C
        0x0A => bitwise::rotate_right_d_extended,       // RRC D
        0x0B => bitwise::rotate_right_e_extended,       // RRC E
        0x0C => bitwise::rotate_right_h_extended,       // RRC H
        0x0D => bitwise::rotate_right_l_extended,       // RRC L
        0x0F => bitwise::rotate_right_a_extended,       // RRC A
        0x10 => bitwise::rotate_left_carry_b_extended,  // RL B
        0x11 => bitwise::rotate_left_carry_c_extended,  // RL C
        0x12 => bitwise::rotate_left_carry_d_extended,  // RL D
        0x13 => bitwise::rotate_left_carry_e_extended,  // RL E
        0x14 => bitwise::rotate_left_carry_h_extended,  // RL H
        0x15 => bitwise::rotate_left_carry_l_extended,  // RL L
        0x17 => bitwise::rotate_left_carry_a_extended,  // RL A
        0x18 => bitwise::rotate_right_carry_b_extended, // RR B
        0x19 => bitwise::rotate_right_carry_c_extended, // RR C
        0x1A => bitwise::rotate_right_carry_d_extended, // RR D
        0x1B => bitwise::rotate_right_carry_e_extended, // RR E
        0x1C => bitwise::rotate_right_carry_h_extended, // RR H
        0x1D => bitwise::rotate_right_carry_l_extended, // RR L
